...
def minimax_alpha_beta(board, depth, alpha, beta, maximizing_player):
    ...
    if maximizing_player:
        ...
        for c in valid:
            ...
            temp_board = board.copy()
            add_tile(temp_board, r, c, AI)
            score = minimax_alpha_beta(temp_board, depth-1, alpha, beta, False)[1]
            if score > value:
                value = score
                best_col = c
        ...
        for c in valid:
            ...
            temp_board = board.copy()
            add_tile(temp_board, r, c, PLAYER)
            score = minimax_alpha_beta(temp_board, depth - 1, alpha, beta, True)[1]
            if score < value:
                value = score
                best_col = c
            beta = min(beta, value)
...
while not game_over:
    ...
    if turn == AI and not game_over:
        ...
        # score, col = minimax_alpha_beta(board, 3,-math.inf, math.inf, True)
        if is_valid(board, col):
